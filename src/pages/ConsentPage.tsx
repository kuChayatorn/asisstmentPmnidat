                ...
                <div className='w-[342px] card items-center shadow-2xl bg-white z-[1]'>
                    <div className="join join-vertical">
                        ...
                        <div className='join-item bg-white  justify-center items-center text-center flex-col  text-white p-6'>
                            <p className='font-sans text-sm font-light leading-[22.4px] tracking-tight text-left decoration-slice text-[#356CA8]'>
                    ...
                    <div className="form-control w-full">
                        <label className="w-full cursor-pointer label flex flex-row item-start justify-start pl-6 gap-3">
                            ...
                            <span className="font-sans text-sm font-light leading-[22.4px] tracking-tight text-left decoration-slice text-[#356CA8]">ข้าพเจ้าได้อ่านและเข้าใจรายละเอียด</span>
                        </label>
                    </div>
